        ...
        <div className="row g-4 align-items-start">
          ...
          <div className="col-lg-6">
            <div className="bg-white rounded-4 shadow p-4 h-100">
              ...
              <div className="text-muted lh-lg">
                <p className="fs-5">
                  أهلاً وسهلاً بكم، أنا الأستاذ أسامة طيب، مدرس متخصص في مواد التاريخ والجغرافيا. 
                  أقدم من خلال هذا الموقع محتوى تعليمي شامل ومتميز لطلابي وجميع المهتمين بهذين المجالين الهامين.
                </p>
                <p>
                  يسعدني أن أشارككم خبرتي التعليمية من خلال مجموعة متنوعة من الموارد التعليمية المصممة 
                  بعناية لتلبية احتياجات الطلاب في مختلف المستويات التعليمية.
                </p>
                <p>
                  هدفي الأساسي هو جعل دراسة التاريخ والجغرافيا أكثر متعة وفهماً، وتوفير بيئة تعليمية 
                  تفاعلية تساعد الطلاب على تحقيق أفضل النتائج الأكاديمية.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-6 d-flex flex-column gap-3">
            ...
            <div className="bg-white rounded-4 shadow p-4">
              ...
              <p className="text-muted">
                امتحانات تجريبية وحلول نموذجية لمساعدة الطلاب في التحضير الأمثل للامتحانات الرسمية.
              </p>
            </div>
          </div>
        </div>
